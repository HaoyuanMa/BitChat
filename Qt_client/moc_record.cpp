...
**
** Created: Mon Sep 2 21:29:25 2019
...
static const char qt_meta_stringdata_record[] = {
    "record\0\0str\0dsb(QString)\0"
};

const QMetaObject record::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_record,
...
int record::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: dsb((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
